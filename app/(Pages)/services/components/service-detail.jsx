        ...
        <div className="lcs-inside" style={{ width: "100%", padding: "3%" }}>
          ...
          <div id="dob">
            <ul id="dob-list" className="shown-services">
              ...
              <li className="item-left">
                After Hours Variance Permits, Assist Contractor with After Hours
                Variances
              </li>
              <li className="item-left">
            ...
            <p id="dob-description" className="description">
              ...
              tempus. Mauris et metus id turpis varius luctus. Lorem ipsum dolor
          ...
          <div id="lpc">
            <ul id="lpc-list" className="shown-services">
              <li>
                Certificate of No Effect (CNE) Including Expedited and FastTrack
                Applications
              </li>
